...
apt-get update
# apt-get install -y nginx php7.3-fpm php7.3-mysql php7.3-cli php7.3-curl git php7.3-dev mysql-server
apt-get install -y nginx php7.3-fpm php7.3-mysql php7.3-cli php7.3-curl git php7.3-dev mariadb-server
service nginx stop
